  ...
  return (
    ...
    <div className='Prof-about d-flex flex-column gap-3'>
      <div>
        ...
        <h3 className='fw-bold'>I'm Rahul<span className='text-warning'>Chouhan</span></h3>
      ...
      <div className='d-flex flex-column gap-4'>
        ...
        <div className='social-handle d-flex gap-4'>
          <a href="https://www.linkedin.com/in/rahul-chouhan-665ab8250/" target='_blank'>
          <img src="/linkdin.png" alt="" />
          </a>
          <a href="https://github.com/Rahulchouhan321"target='_blank'>
